...
void ListView::addPacketItem(SnifferData &tmpSnifferData, bool fnew, bool display){
    if (display) {
        ...
        case ETHERTYPE_IP: color = new QColor(100,255,100); break;
        case ETHERTYPE_ARP: color = new QColor(100,100,255); break;
        case ETHERTYPE_IPV6: color = new QColor(255,100,100); break;
        default: color = new QColor(200,200,200); break;
        }
        qcolor = *color;
        for (int i=0; i<7; i++) {
